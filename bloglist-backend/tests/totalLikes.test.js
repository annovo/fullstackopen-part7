...
describe('total likes', () => {
  ...
  test('when list has many blogs equal the likes of theirs likes', () => {
...
describe('most blogs', () => {
  ...
  test('of one blog is this author', () => {
  ...
  test('of many blogs is author with most blogs', () => {
...
describe('most likes', () => {
  ...
  test('of many blogs is author with most likes', () => {
